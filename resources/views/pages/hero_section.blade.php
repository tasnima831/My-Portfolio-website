    ...
    <section class="hero hero--editorial" id="home">
        <div class="hero-copy">
            ...
            <div class="hero-actions">
                ...
                <a class="hero-work-button" href="#gallery">View My Work</a>
            </div>
        <nav class="social-orbit" aria-label="Social media">
            <div class="social-orbit__ring">
                <a class="social-orbit__link" href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" aria-label="Facebook (opens in a new tab)" title="Facebook">
                ...
                <a class="social-orbit__link" href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" aria-label="Instagram (opens in a new tab)" title="Instagram">
                ...
                <a class="social-orbit__link" href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn (opens in a new tab)" title="LinkedIn">
                ...
                <a class="social-orbit__link" href="https://mail.google.com/" target="_blank" rel="noopener noreferrer" aria-label="Gmail (opens in a new tab)" title="Gmail">
